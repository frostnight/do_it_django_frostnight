...
class TestView(TestCase):
    ...
    def test_comment_form(self):
        ...
        comment_area = soup.find('section', id='comment-area')
        new_commnet_div = comment_area.find('div', id=f'comment-{new_comment.pk}')
        self.assertIn('obama', new_commnet_div.text)
        self.assertIn('오바마의 댓글입니다', new_commnet_div.text)
    ...
    def test_update_post(self):
        ...
        self.assertIn('위 아 더 월드', main_area.text)
